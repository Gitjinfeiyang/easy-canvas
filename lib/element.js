...
export default class Element {
  ...
  _completeWidth() {
    ...
    if(isOuter(this.styles.width)){
      if(this.parent && isAuto(this.parent.styles.width)){
        this.styles.width = STYLES.WIDTH.AUTO
      }
    }

    if(isOuter(this.styles.height)){
      if(this.parent && isAuto(this.parent.styles.height)){
        this.styles.height = STYLES.WIDTH.AUTO
      }
    }
  }
