...
import { isExact, walk, isOuter, parseOuter, walkParent } from './utils'
...
export default class Element {
  ...
  // 是否父节点下的最后一个
  _isEndNode() {
    return this.parent && !this.next && !this.hasChildren()
  }
  ...
  _patchInlineBlockAlign() {
    ...
    if (textAlign === 'left' || !textAlign || !children.length) return
